                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $email->contato_cidade . '<br>' . '<i>'.$email->contato_estado.'</i>' ?></td>
                      <td>
                          <?php echo $email->contato_pessoa_tipo ?><br>
                          <?php echo ($email->contato_peca ? '<i>Peça: '.$email->contato_peca.'</i>' : '') ?>
                      </td>
                      ...
                      <div class="modal fade" id="email<?php echo $email->Id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">Para excluir este email clica em "Sim".</div>
                              <div class="modal-footer">
                                <button class="btn btn-success btn-sm" type="button" data-dismiss="modal">Não</button>
                                <a class="btn btn-danger btn-sm" href="<?php echo base_url('emails/deletar/'.$email->Id) ?>">Sim</a>
