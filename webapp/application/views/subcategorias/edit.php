        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" name="form_edit" class="user">
                    <fieldset class="mb-4 border p-2">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="scat_titulo" aria-describedby="emailHelp" value="<?php echo $subcategorias->scat_titulo ?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php foreach ($categorias as $categoria) : ?>
                                        ...
                                        <?php echo $categoria->cat_id == $subcategorias->scat_categoria ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="scat_destaque" class="form-control">
                                    <option value="0" <?php echo ($subcategorias->scat_destaque == 0) ? 'selected' : '' ?>>Não</option>
                                    <option value="1" <?php echo ($subcategorias->scat_destaque == 1) ? 'selected' : '' ?>>Sim</option>
                                </select>
                            </div>
                        </div>
                    </legend>
                    ...
                    <input type="hidden" name="scat_id" value="<?php echo $subcategorias->scat_id ?>">
